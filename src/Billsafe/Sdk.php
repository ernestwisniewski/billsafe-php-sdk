<?php namespace ErnestWisniewski\Billsafe;
...
use ErnestWisniewski\Billsafe\Http\Client;
use stdClass;
...
class Sdk {
     ...
     * $logger may be an instance of the LoggerXXX classes shipped
    ...
    public function callMethod($methodName, $parameter)
    {
        ...
        {
            throw new BillsafeException('parameter must be an object or an array');
        }
        ...
        $httpClient = new Client($this->_getApiUrl());
        ...
        {
            throw new BillsafeException('invalid server response! Status code is not 200 / OK!');
        }
        ...
        {
            throw new BillsafeException('invalid server response! Element "ack" not found!');
        }
